...
public class DbRuleManager {
    ...
    public boolean updateSmsEnable(String jid, int enable) {
        Connection con = null;
        PreparedStatement pstmt = null;

        try {
            con = DbConnectionManager.getConnection();
            pstmt = con.prepareStatement(UPDATE_SMS_ENABLE);
    ...
    public boolean updateSms(String jid, String cellphone) {
        ...
        try {
            con = DbConnectionManager.getConnection();
            pstmt = con.prepareStatement(UPDATE_SMS_PHONE);
    ...
    public boolean updateMsn(String jid, String msn) {
        Connection con = null;
        PreparedStatement pstmt = null;
    ...
    public boolean updateMsnEnable(String jid, int enable) {
        Connection con = null;
        PreparedStatement pstmt = null;

        try {
            con = DbConnectionManager.getConnection();
            pstmt = con.prepareStatement(UPDATE_MSN_ENABLE);
