...
<head>
    ...
    <title>添加任务</title>
    <style type="text/css">@import url('<c:url value="/styles/home.css"/>');
    </style>
    ...
    <script type="text/javascript" src='<c:url value="/components/job.js"/>'>
    </script>
</head>
<body>
...
<p><a href="list.do">调度任务监控管理</a></p>

<form id="myForm1" action="addSimpleTrigger.do" method="post">
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>
                <img id="calBegin" src="components/calendar/skins/aqua/cal.gif" border="0" alt="开始时间"
                     style="cursor:pointer">（Trigger执行开始时间，必填）
            </td>
        </tr>
        <tr>
            <td nowrap>
            ...
            <td>
                <img id="calEnd" src="components/calendar/skins/aqua/cal.gif" border="0" alt="结束时间"
                     style="cursor:pointer">（Trigger执行结束时间，可以不填写）
            </td>
        </tr>
        <tr>
            <td nowrap>
...
<form id="myForm2" action="addCronTriggerByExpression.do" method="post">
    <table>
        <tr>
            <th colspan="3" bgcolor="00ff00">
                <b>Cron Trigger 1</b>
...
<form id="myForm4" action="addSimpleJob.do" method="post">
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="mainClass">
            </td>
        </tr>
        <tr>
            <td nowrap>
            ...
            <td>
                <input type="text" name="args">(参数间用空格隔开)
            </td>
        </tr>
        <tr>
            <td nowrap>
